package com.shofikul.androiddownloadexample.utils;
...
import com.shofikul.androiddownloadexample.R;
...
/**
 * Created by Shofikul Islam on 01/01/2020.
 */
public class DownloadTask {
    ...
    public DownloadTask(Context context, Button buttonText, String downloadUrl, Boolean isImage) {
    ...
    private class DownloadingTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            try {
                ...
                if (isImage){
                    Log.d("downloadFileName.jpg","are");
                    outputFile = new File(apkStorage, "downloadFileName.jpg");//Create Output file in Main File
